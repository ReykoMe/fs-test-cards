...
const UserPostsPopUp = ( { onClickHandler, userPosts } ) => {
    ...
    return (
        <div id="wrapper"
            className="col-12 position-fixed vh-100 d-flex flex-wrap flex-direction-column align-content-center"
            style={ { zIndex: '2000', left: '0', backgroundColor: 'rgba(255,255,255, 0.8)' } } onClick={ ( e ) => {
                closePopupHandler( e )
            } }>
